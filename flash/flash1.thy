...
exTwoLessP N (%i j.  r=NI_InvAck_1 i j)  \<or>
...
( r=NI_Nak_Clear )\<or>
( r=NI_Nak_Home )\<or>
exTwoLessP N (%i j.  r=NI_Remote_GetX_Nak i j)  \<or>
exLessP N (%i.  r=NI_Remote_GetX_Nak_Home i )  \<or>
exTwoLessP N (%i j.  r=NI_Remote_GetX_PutX i j)  \<or>
exLessP N (%i.  r=NI_Remote_GetX_PutX_Home i )  \<or>
exLessP N (%i.  r=NI_Remote_Get_Nak1 i )  \<or>
exTwoLessP N (%i j.  r=NI_Remote_Get_Nak2 i j)  \<or>
exLessP N (%i.  r=NI_Remote_Get_Put1 i )  \<or>
exTwoLessP N (%i j.  r=NI_Remote_Get_Put2 i j)  \<or>
...
definition allIniSpecs ::"nat\<Rightarrow>formula list" where [simp]:
   ...
   "allIniSpecs  N \<equiv>[ (  iniStateSpecOfCacheState N )
