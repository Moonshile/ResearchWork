theory flash1 imports cacheBeta
begin
...
axiomatization where axiomOn_Dir_InvSet  [simp]:"   s (IVar (Para ''Dir-InvSet'' i )) \<in> Bool "

axiomatization where axiomOn_Dir_ShrSet  [simp]:"   s (IVar (Para ''Dir-ShrSet'' i )) \<in> Bool "

axiomatization where axiomOn_Dir_Dirty  [simp]:"   s (IVar (Global ''Dir.Dirty'' )) \<in> Bool "


axiomatization where axiomOn_Dir_HeadVld  [simp]:"   s (IVar (Global ''Dir.HeadVld'' )) \<in> Bool "

axiomatization where axiomOn_Dir_Pending  [simp]:"   s (IVar (Global ''Dir.Pending'' )) \<in> Bool "

axiomatization where axiomOn_Dir_ShrVld  [simp]:"   s (IVar (Global ''Dir.ShrVld'' )) \<in> Bool "

axiomatization where axiomOn_Dir_local  [simp]:"   s (IVar (Global ''Dir.local'' )) \<in> Bool "
...
axiomatization where axiomOn_InvMsg_Cmd  [simp]:"   s (IVar (Para ''InvMsg.Cmd'' i )) \<in> INV_CMDType "
...
axiomatization where axiomOn_NakcMsg_Cmd  [simp]:"   s (IVar (Global ''NakcMsg.Cmd'' )) \<in> NAKC_CMDType "



axiomatization where axiomOn_RpMsg_Cmd  [simp]:"   s (IVar (Para ''RpMsg.Cmd'' i )) \<in> RP_CMDType "

axiomatization where axiomOn_ShWbMsg_Cmd  [simp]:"   s (IVar (Global ''ShWbMsg.Cmd'' )) \<in> SHWB_CMDType "



axiomatization where axiomOn_UniMsg_Cmd  [simp]:"   s (IVar (Para ''UniMsg.Cmd'' i )) \<in> UNI_CMDType "



axiomatization where axiomOn_WbMsg_Cmd  [simp]:"   s (IVar (Global ''WbMsg.Cmd'' )) \<in> WB_CMDType "
...
definition NI_InvAck_2::" nat \<Rightarrow> rule" where [simp]:
"NI_InvAck_2 iInv1 \<equiv>
...
definition NI_Local_GetX_PutX1::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX1  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX2::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX2  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX3::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX3  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX4::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX4  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX5::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX5  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX6::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX6  iInv1 \<equiv>   
let g=( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( eqn ( IVar ( Para ''UniMsg.Cmd'' iInv1) )  ( Const UNI_GetX ))    
(    let natList=down N in 
    let paraForm=\<lambda>iInvForAll. ( eqn ( IVar ( Para ''Dir-ShrSet'' iInvForAll) )  ( Const false ))  in
       forallForm natList paraForm)
...
definition NI_Local_GetX_PutX7::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX7  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX8::" nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX8  iInv1 iInv2\<equiv>   
...
definition NI_Local_GetX_PutX8_home::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX8_home  iInv1 \<equiv>   
let g=( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( eqn ( IVar ( Para ''UniMsg.Cmd'' iInv1) )  ( Const UNI_GetX ))     (neg ( eqn ( IVar ( Para ''procCmd'' Home) )  ( Const NODE_Get )) )  )    ( eqn ( IVar ( Global ''Dir.local'') )  ( Const true ))  )    ( eqn ( IVar ( Para ''Dir-ShrSet'' Home) )  ( Const true ))  )    ( eqn ( IVar ( Global ''Dir.HeadPtr'') )   (Const iInv1))  )    ( eqn ( IVar ( Global ''Dir.HeadVld'') )  ( Const true ))  )    ( eqn ( IVar ( Global ''Dir.Dirty'') )  ( Const false ))  )    ( eqn ( IVar ( Global ''Dir.Pending'') )  ( Const false ))  )    ( eqn ( IVar ( Para ''UniMsg.proc'' iInv1) )  (Const    Home))  )  in 
let S=(
let S_1=( assign  (( Global ''Dir.Pending''),  ( Const true ) ) ) in
let S_2=( assign  (( Global ''Dir.local''),  ( Const false ) ) ) in
...
definition NI_Local_GetX_PutX9::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX9  iInv1 \<equiv>   
...
definition NI_Local_GetX_PutX10::" nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX10  iInv1 iInv2\<equiv>   
...
definition NI_Local_GetX_PutX10_home::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX10_home  iInv1 \<equiv>   
let g=( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( andForm ( eqn ( IVar ( Para ''UniMsg.Cmd'' iInv1) )  ( Const UNI_GetX ))    ( eqn ( IVar ( Global ''Dir.local'') )  ( Const false ))  )    ( eqn ( IVar ( Para ''Dir-ShrSet'' Home) )  ( Const true ))  )    ( eqn ( IVar ( Global ''Dir.HeadPtr'') )   (Const iInv1))  )    ( eqn ( IVar ( Global ''Dir.HeadVld'') )  ( Const true ))  )    ( eqn ( IVar ( Global ''Dir.Dirty'') )  ( Const false ))  )    ( eqn ( IVar ( Global ''Dir.Pending'') )  ( Const false ))  )    ( eqn ( IVar ( Para ''UniMsg.proc'' iInv1) )  (Const    Home))  )  in 
let S=(
let S_1=( assign  (( Global ''Dir.Pending''),  ( Const true ) ) ) in
let S_2=( assign  (( Global ''Dir.local''),  ( Const false ) ) ) in
...
definition NI_Local_GetX_PutX11::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_GetX_PutX11  iInv1 \<equiv>   
...
definition NI_Local_Get_Put1::" nat \<Rightarrow> rule" where [simp]:
" NI_Local_Get_Put1 iInv1 \<equiv>   
...
definition NI_ShWb::" rule" where [simp]:
" NI_ShWb \<equiv>   
...
definition PI_Local_GetX_PutX1::" rule" where [simp]:
" PI_Local_GetX_PutX1 \<equiv>   
...
definition PI_Local_GetX_PutX2::" rule" where [simp]:
" PI_Local_GetX_PutX2 \<equiv>   
...
exLessP N (%i.  r=NI_Local_GetX_PutX1 i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX2 i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX3 i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX4 i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX5 i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX6 i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX7 i)  \<or>
(*exTwoLessP N (%i j.  r=NI_Local_GetX_PutX8  i j)  \<or>*)
exLessP N (%i.  r=NI_Local_GetX_PutX8_home i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX9 i)  \<or>
(*exTwoLessP N (%i j.  r=NI_Local_GetX_PutX10  i j)  \<or>*)
exLessP N (%i.  r=NI_Local_GetX_PutX10_home i)  \<or>
exLessP N (%i.  r=NI_Local_GetX_PutX11 i)  \<or>
...
exLessP N (%i.  r=NI_Local_Get_Put1 i)  \<or>
...
( r=PI_Local_GetX_PutX1 )\<or>
( r=PI_Local_GetX_PutX2 )\<or>
